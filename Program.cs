     ...
     public void Menu()
        ...
        Console.WriteLine(defdir);
                ...
                else if (men=="5")
            {
                ...
                if (!File.Exists("1.txt") && !File.Exists("2.txt") && !File.Exists("3.txt") && !File.Exists("4.txt") && !File.Exists("5.txt"))
                {
                    Console.WriteLine("Nerasti failai.");
                }
                else if ((strat=="1")&&File.Exists("1.txt") && File.Exists("2.txt") && File.Exists("3.txt") && File.Exists("4.txt") && File.Exists("5.txt"))
                {

                    ReadF(defdir+@"\1.txt");
                    Console.WriteLine("1.txt failas perskaitytas");
                    ReadF(defdir+@"\2.txt");
                    Console.WriteLine("2.txt failas perskaitytas");
                    ReadF(defdir+@"\3.txt");
                    Console.WriteLine("3.txt failas perskaitytas");
                    ReadF(defdir+@"\4.txt");
                    Console.WriteLine("4.txt failas perskaitytas");
                    ReadF(defdir+@"\5.txt");
                    Console.WriteLine("5.txt failas perskaitytas");
                ...
                else if ((strat == "2") && File.Exists("1.txt") && File.Exists("2.txt") && File.Exists("3.txt") && File.Exists("4.txt") && File.Exists("5.txt"))
                {
                    ReadF(defdir + @"\1.txt");
                    Console.WriteLine("1.txt failas perskaitytas");
                    ReadF(defdir + @"\2.txt");
                ...
                else if ((strat == "3") && File.Exists("1.txt") && File.Exists("2.txt") && File.Exists("3.txt") && File.Exists("4.txt") && File.Exists("5.txt"))
                {
                    ReadF(defdir + @"\1.txt");
                    Console.WriteLine("1.txt failas perskaitytas");
                    ReadF(defdir + @"\2.txt");
